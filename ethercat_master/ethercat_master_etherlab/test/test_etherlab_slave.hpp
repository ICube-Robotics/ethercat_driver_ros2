...
{
public:
  explicit FriendEtherlabSlave(std::shared_ptr<ethercat_interface::EcSlaveBase> slave)
  : EtherlabSlave(slave) {}
...
class TestSlave : public ethercat_generic_plugins::GenericEcSlave
// public ethercat_interface::EcSlaveBase
{
  FRIEND_TEST(EtherlabSlaveTest, SlaveSetup);
  FRIEND_TEST(EtherlabSlaveTest, SlaveSetupPdoChannels);
  FRIEND_TEST(EtherlabSlaveTest, SlaveSetupSyncs);
