  ...
  if (slave_config.size() != 0) {
    ...
    if (slave_config["rpdo"]) {
      for (auto i = 0ul; i < slave_config["rpdo"].size(); i++) {
        ...
        ethercat_interface::pdo_channels_t rpdo_channels_info;
        ...
        rpdo_mapping.pdo_channel_config = rpdo_channels_info;
    ...
    if (slave_config["tpdo"]) {
      for (auto i = 0ul; i < slave_config["tpdo"].size(); i++) {
        ...
        ethercat_interface::pdo_channels_t tpdo_channels_info;
        ...
        tpdo_mapping.pdo_channel_config = tpdo_channels_info;
